 ...
 * @author wizard
 */
public final class CursoService extends Service {
    ...
    /*Insertar alumnos*/
    public void insertar_curso(final Curso alumno) throws GlobalException, NoDataException {
        try {
            Connect();
    ...
    /*Modificar alumnos*/
    public void modificar_curso(final Curso alumno) throws GlobalException, NoDataException {
        try {
            Connect();
        } catch (ClassNotFoundException e) {
            throw new GlobalException("No se ha localizado el driver");
