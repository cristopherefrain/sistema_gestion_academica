 ...
 * @author wizard
 */
public final class CarreraService extends Service {
    ...
    /*Insertar profesores*/
    public void insertar_carrera(final Carrera carrera) throws GlobalException, NoDataException {
        try {
            Connect();
    ...
    public void modificar_carrera(final Carrera carrera) throws GlobalException, NoDataException {
        try {
            Connect();
        } catch (ClassNotFoundException e) {
            throw new GlobalException("No se ha localizado el driver");
