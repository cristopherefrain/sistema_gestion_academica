 ...
 * @author wizard
 */
public final class AlumnoService extends Service {
    ...
    /*Insertar Alumnos*/
    public void insertar_alumno(final Alumno alumno) throws GlobalException, NoDataException {
        try {
            Connect();
    ...
    /*Modificar Alumnos*/
    public void modificar_alumno(final Alumno alumno) throws GlobalException, NoDataException {
        try {
            Connect();
        } catch (ClassNotFoundException e) {
            throw new GlobalException("No se ha localizado el driver");
