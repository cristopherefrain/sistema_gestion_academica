...
public class CarreraAdapter extends RecyclerView.Adapter<CarreraAdapter.MyViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.title1.setText(carrera.getCodigo_carrera());
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (Carrera row : carreraList) {
                        ...
                        if (row.getCodigo_carrera().toLowerCase().contains(charString.toLowerCase()) || row.getNombre().toLowerCase().contains(charString.toLowerCase())) {
