...
import Controllers.ProfesorListadoController;
...
public final class ProfesorListadoView extends JInternalFrame implements Observer {

    private ProfesorListadoController controller;
    private ObjetoListadoModel<Profesor, String> model;

    public void setController(ProfesorListadoController controller) {
    ...
    public ObjetoListadoModel<Profesor, String> getModel() {
        return model;
    }
